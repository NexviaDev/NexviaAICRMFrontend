...
export default function ContactExcelImportMappingModal({
  onClose,
  saving,
  onImport,
  excelRows,
  ...
  const saveMsgIsError = saveMsg && (saveMsg.includes('실패') || saveMsg.includes('필요') || saveMsg.includes('누락'));
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="cce-excel-map-title"
    >
      <div className="opp-modal excel-import-map-modal" onClick={(e) => e.stopPropagation()}>
        <div className="opp-modal-header">
          <div className="opp-modal-header-left">
            <h3 className="opp-modal-title" id="cce-excel-map-title">
              엑셀 → 연락처 매핑
            </h3>
          ...
          <div className="opp-modal-form-layout excel-import-map-form-layout">
            <div className="opp-modal-form-main excel-import-map-form-main">
              <div className="excel-import-map-intro">
                <h2 className="excel-import-map-intro-title">연락처 일괄 등록</h2>
                <p className="excel-import-map-intro-desc">
                  엑셀 <strong>첫 행은 헤더</strong>(열 이름)로 사용됩니다. 각 열을 <strong>연락처 필드</strong>에
                  연결한 뒤 <strong>가져오기</strong>를 누르세요. 대상 필드는 서버 스키마에서 자동으로 불러오며,
                  커스텀 필드가 추가되면 여기에도 반영됩니다.
                </p>
              </div>
              ...
              <label className="opp-label excel-import-map-assignee" htmlFor="cce-import-assignee-input">
                <span>담당자</span>
                <div className="excel-import-map-assignee-row">
                  <input
                    id="cce-import-assignee-input"
                    type="text"
                    className="opp-input"
