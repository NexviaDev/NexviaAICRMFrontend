...
export default function ContactExcelImportMappingModal({
  ...
  return (
    <div className="lc-crm-map-overlay" role="dialog" aria-modal="true" aria-labelledby="cce-excel-map-title">
      <div className="lc-crm-map-panel" onClick={(e) => e.stopPropagation()}>
        <header className="lc-crm-map-head">
          <div className="lc-crm-map-head-left">
            ...
            <h2 id="cce-excel-map-title">엑셀 → 연락처 매핑</h2>
        ...
        <div className="lc-crm-map-body">
          <div className="lc-crm-map-title-block">
            ...
            <p className="lc-crm-map-lead-hint">
              엑셀 <strong>첫 행은 헤더</strong>(열 이름)로 사용됩니다. 각 열을 <strong>연락처 필드</strong>에 연결한 뒤{' '}
          ...
          <p className="lc-crm-map-target-desc" style={{ marginBottom: '1rem' }}>
            미리보기는 <strong>첫 데이터 행</strong> 기준입니다. <strong>가져오기</strong>를 누르면 매핑된 행마다 연락처가 순서대로 등록됩니다.
          </p>
          ...
          <div className="add-company-field add-company-field-assignee" style={{ marginBottom: '1rem' }}>
            <label className="add-company-label" htmlFor="cce-import-assignee-input">담당자</label>
