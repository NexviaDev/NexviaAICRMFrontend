          ...
          <div className="login-card-body">
            ...
            <div className="login-oauth-stack">
              <button
                ...
                onClick={() => beginOAuthRedirect(getGoogleAuthUrl())}
              >
              ...
              <button
                ...
                onClick={() => beginOAuthRedirect(getNaverAuthUrl())}
              >
                <span className="login-naver-icon" aria-hidden>N</span>
                <span className="login-naver-label">네이버 아이디로 로그인</span>
              </button>
            </div>
